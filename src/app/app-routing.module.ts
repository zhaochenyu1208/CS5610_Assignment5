...
const routes: Routes = [
  ...
  {path: 'profile/:uid/website/:websiteId/page/:pageId/widget/new/html', component: WidgetHtmlComponent},
  {path: 'profile/:uid/website/:websiteId/page/:pageId/widget/new/text', component: WidgetTextComponent},
  ...
  {path: 'profile/:uid/website/:websiteId/page/:pageId/widget/:widgetId/edit/html', component: WidgetHtmlComponent},
  {path: 'profile/:uid/website/:websiteId/page/:pageId/widget/:widgetId/edit/text', component: WidgetTextComponent},
